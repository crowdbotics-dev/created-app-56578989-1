"""
Django settings for created_app_56578989_1 project.
...
ROOT_URLCONF = 'created_app_56578989_1.urls'
...
WSGI_APPLICATION = 'created_app_56578989_1.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Created App 56578989 Support <support@created-app-56578989-1.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "created_app_56578989_1 API",
    "DESCRIPTION": "API documentation for created_app_56578989_1 App",
    "VERSION": "v1",
}
...
if AS_BUCKET_NAME:
    ...
    DEFAULT_FILE_STORAGE = "created_app_56578989_1.storage_backends.AzureMediaStorage"
    STATICFILES_STORAGE = "created_app_56578989_1.storage_backends.AzureStaticStorage"
